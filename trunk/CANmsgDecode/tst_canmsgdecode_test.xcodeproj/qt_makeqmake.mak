...
QMAKE    = /usr/bin/qmake
tst_canmsgdecode_test.xcodeproj/project.pbxproj: CANmsgDecode_Test.pro  /usr/local/Qt4.8/mkspecs/macx-xcode/qmake.conf /usr/local/Qt4.8/mkspecs/common/unix.conf \
	...
	$(QMAKE) -o tst_canmsgdecode_test.xcodeproj/project.pbxproj CANmsgDecode_Test.pro
